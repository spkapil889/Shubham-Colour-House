...
const BrushStroke = ({ className, color = "currentColor" }: { className?: string, color?: string }) => (
  <svg viewBox="0 0 500 100" className={className} preserveAspectRatio="none">
    <path
      d="M0,50 C150,20 350,80 500,50 L500,100 L0,100 Z"
      fill={color}
      opacity="0.15"
    />
    <path
      d="M0,60 C100,30 400,90 500,40"
      stroke={color}
      strokeWidth="8"
      strokeLinecap="round"
      fill="none"
...
const trustStats = [
  ...
  { label: 'Certified Expertise', value: '124+', icon: Award, color: 'text-orange-600', bgColor: 'bg-orange-50', borderColor: 'border-orange-100' },
    ...
    <div className="overflow-hidden bg-white">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-brand-dark">
        ...
        <div className="absolute inset-0 z-10 pointer-events-none">
          <div className="absolute top-0 left-0 w-full lg:w-[55%] h-full bg-brand-orange transform -skew-x-12 -translate-x-20 hidden lg:block" />
          <div className="absolute inset-0 bg-brand-orange/90 lg:hidden" />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <div className="relative inline-block mb-6">
                <div className="absolute -top-4 -left-4 w-12 h-12 border-t-4 border-l-4 border-white/30" />
                <span className="text-xl md:text-2xl font-black tracking-widest uppercase bg-white/20 px-4 py-1 backdrop-blur-sm">
                  Alwar's #1 Choice
                </span>
              </div>
              
              <h1 className="text-6xl md:text-[120px] font-black leading-[0.9] mb-8">
                PREMIUM <br />
                <span className="text-brand-dark">PAINT</span> <br />
                SOLUTIONS
              </h1>
              ...
              <div className="flex flex-wrap gap-6 mt-12">
                <Link
                  to="/products"
                  className="bg-brand-dark text-white px-12 py-6 rounded-2xl font-black text-2xl hover:bg-brand-blue transition-all transform hover:-translate-y-2 flex items-center gap-3"
                >
                  EXPLORE <ArrowRight className="w-8 h-8" />
                </Link>
                <Link
                  to="/calculator"
                  className="bg-white text-brand-orange px-12 py-6 rounded-2xl font-black text-2xl hover:bg-brand-dark hover:text-white transition-all transform hover:-translate-y-2"
                >
                  FREE ESTIMATE
                </Link>
              </div>
            ...
            >
              <div className="relative">
                <div className="bg-white p-10 rounded-[3rem] transform rotate-3 hover:rotate-0 transition-transform duration-500 relative z-10">
                  <div className="absolute -top-6 -right-6 w-24 h-24 bg-brand-blue rounded-full flex items-center justify-center text-white font-black text-xl animate-bounce">
                    30+ <br /> YRS
                  </div>
                  <p className="text-brand-dark text-2xl md:text-3xl font-black leading-tight text-center uppercase">
                    Transform your <br />
                    <span className="text-brand-orange">dream home</span> <br />
                    with our expert <br />
                    range!
                  </p>
                ...
                {/* Decorative Paint Splatter Effect */}
        ...
        {/* Bottom Brush Shade */}
        <BrushStroke className="absolute bottom-0 left-0 w-full h-24 text-white z-30" />
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              {/* Artistic Brush Shades */}
              <div className="absolute -top-10 -left-10 w-40 h-40 bg-brand-blue/10 rounded-full blur-3xl animate-pulse" />
              <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-brand-purple/10 rounded-full blur-3xl animate-pulse" />
              <BrushStroke className="absolute -bottom-12 -left-12 w-64 h-24 text-brand-blue rotate-12" />
            </motion.div>
      ...
      <section className="py-32 bg-gray-50 relative overflow-hidden">
        <BrushStroke className="absolute top-0 right-0 w-full h-32 text-white rotate-180" />
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
              <div className="space-y-6">
                <span className="text-brand-orange font-black tracking-widest uppercase text-sm flex items-center gap-3">
                  <div className="w-10 h-1 bg-brand-orange rounded-full" />
                  How it works
                </span>
                <h2 className="text-4xl md:text-6xl font-black text-brand-dark leading-tight">
                  Always on Time and <br />
                  <span className="text-brand-orange text-stroke">Never Delay</span>
                </h2>
                <p className="text-gray-600 text-xl leading-relaxed">
              ...
              <div className="space-y-8">
                {[
                  ...
                  >
                    <div className="flex-shrink-0 w-20 h-20 bg-white rounded-3xl flex flex-col items-center justify-center border border-gray-100 group-hover:border-brand-orange transition-colors">
                      <span className="text-brand-orange font-black text-lg">{item.step}</span>
                      <item.icon className="w-6 h-6 text-gray-300 group-hover:text-brand-orange transition-colors" />
                    </div>
                    <div className="pt-2">
            ...
            >
              <div className="rounded-[4rem] overflow-hidden border-[12px] border-white bg-white">
                <img
                  src="https://shubhamcolourhouse.com/wp-content/uploads/2025/09/Group-32.png"
              ...
              <div className="absolute -bottom-12 -right-12 bg-brand-blue p-10 rounded-[3rem] text-white max-w-xs hidden md:block">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="font-black text-xl">Timely Work</span>
                </div>
                <p className="text-white/80 leading-relaxed">We guarantee on-time project delivery without compromising on quality.</p>
              </div>
              <BrushStroke className="absolute -top-12 -left-12 w-48 h-20 text-brand-orange -rotate-12" />
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="relative order-2 lg:order-1">
              <div className="relative z-10 rounded-[3rem] overflow-hidden border-[12px] border-white bg-white">
                <img
                  src="https://shubhamcolourhouse.com/wp-content/uploads/2025/09/Group-33.png"
              ...
              <BrushStroke className="absolute -bottom-10 left-0 w-full h-24 text-brand-purple" />
              <BrushStroke className="absolute -top-10 right-0 w-48 h-16 text-brand-blue rotate-180" />
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              { title: 'Cleanliness', desc: 'Neat, organized work with minimal disruption to your home.', icon: Paintbrush, color: 'text-orange-600', bg: 'bg-orange-50' }
            ].map((item, idx) => (
              <motion.div
                key={idx}
                whileHover={{ y: -15 }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
              ...
              >
                <div className="rounded-[3rem] overflow-hidden border-4 border-white/10 bg-white p-4">
                  <img
                    src="https://shubhamcolourhouse.com/wp-content/uploads/2025/09/Group-31.png"
                    alt="Color Palette"
                    className="w-full h-full object-contain"
                    referrerPolicy="no-referrer"
                  />
                </div>
                <div className="absolute -bottom-8 -right-8 bg-brand-orange p-8 rounded-full animate-bounce">
                  <Star className="w-8 h-8 text-white fill-current" />
                </div>
                <BrushStroke className="absolute -top-12 -left-12 w-48 h-20 text-brand-blue -rotate-12" />
              </motion.div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <BrushStroke className="w-48 h-8 mx-auto text-brand-blue mt-4" />
          </div>
          <motion.div
        ...
        <BrushStroke className="absolute -bottom-10 right-0 w-64 h-24 text-brand-orange/20 rotate-12" />
      </section>
      ...
      <section className="py-32 bg-gray-50 relative overflow-hidden">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-20 space-y-6">
            <span className="text-brand-orange font-black tracking-widest uppercase text-sm">Common Queries</span>
      ...
      <section className="py-32 bg-white">
        <div className="container mx-auto px-4">
          <div className="bg-brand-orange rounded-[5rem] p-12 md:p-32 text-center text-white relative overflow-hidden">
            <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10" />
            ...
            <div className="relative z-10 space-y-12">
              <h2 className="text-5xl md:text-8xl font-black tracking-tight leading-none">Ready to <br />Transform?</h2>
              <p className="text-xl md:text-3xl text-white/90 max-w-4xl mx-auto font-medium leading-relaxed">
                Visit our showroom today or talk to our experts for a free consultation and the best deals on premium paints.
              </p>
              <div className="flex flex-wrap justify-center gap-8 pt-8">
                <Link
                  to="/contact"
                  className="bg-white text-brand-orange px-14 py-6 rounded-full font-black text-2xl hover:bg-brand-dark hover:text-white transition-all transform hover:scale-110"
                >
                  Contact Us Today
                </Link>
                <Link
                  to="/need-a-painter"
                  className="bg-brand-dark text-white px-14 py-6 rounded-full font-black text-2xl hover:bg-brand-blue transition-all transform hover:scale-110"
                >
                  Find a Painter
                </Link>
              </div>
